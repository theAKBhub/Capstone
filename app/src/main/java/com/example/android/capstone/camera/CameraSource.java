    ...
    public static class Builder {
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            if ((width <= 0) || (width > MAX) || (height <= 0) || (height > MAX)) {
                throw new IllegalArgumentException(String.format(mContext.getString(R.string.error_camera_invalid_dimen), width, height));
            }
        ...
        public Builder setFacing(int facing) {
            if ((facing != CAMERA_FACING_BACK) && (facing != CAMERA_FACING_FRONT)) {
                throw new IllegalArgumentException(String.format(mContext.getString(R.string.error_camera_invalid_facing), facing));
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                Timber.w(mContext.getString(R.string.warning_camera_zoom));
                return currentZoom;
            }
